...
export function useDynamicContent(category: string) {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      try {
        const currentContent = getCurrentContent(category)
...
function getCurrentContent(category: string): ContentItem[] {
  const now = new Date()
  ...
  const latestContent: Record<string, ContentItem[]> = {
    ...
    anwendungen: [
      ...
      },
      {
        ...
        description: "CRM-Plattform mit integrierten AI-Agenten für Workflow-Automatisierung und Kundeninteraktionen",
        date: "2025-03-13",
        category: "Anwendungen",
      ...
      },
      {
        ...
        description: "AI-gesteuerter Roboter bereitet Kaffee in geschäftiger Küche zu - Durchbruch für AI-Maschinen",
        date: "2025-03-12",
        category: "Anwendungen",
      ...
      },
      {
        ...
        description: "Neue Smartphone-Serie mit fortgeschrittenen AI-Funktionen für personalisierte Nutzererfahrungen",
        date: "2025-01-31",
        category: "Anwendungen",
        link: "https://www.marketingprofs.com/opinions/2025/52609/ai-update-january-24-2025-ai-news-and-views-from-the-past-week",
        isRecent: true,
      ...
      },
      {
        ...
        description: "AI-System zur Verbesserung der Effizienz und Kostensenkung in öffentlichen Diensten eingeführt",
        date: "2025-01-29",
        category: "Anwendungen",
        link: "https://www.marketingprofs.com/opinions/2025/52609/ai-update-january-24-2025-ai-news-and-views-from-the-past-week",
        isRecent: true,
    ...
    "chancen-risiken": [
      {
        ...
        description: "Klage wegen angeblich unbefugter Nutzung urheberrechtlich geschützter Inhalte für AI-Training",
        date: "2025-03-14",
