...
export default async function ToolsPage() {
  const articles: Article[] = await fetchGoogleNewsRss("KI Tools Software ChatGPT Claude Gemini Deutschland")
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="pt-1 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">KI-Tools</h1>
            <p className="text-muted-foreground">
              Aktuelle Nachrichten zu KI-Tools und Software für den praktischen Einsatz
            </p>
          </div>
